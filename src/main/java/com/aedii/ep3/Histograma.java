...
public class Histograma extends JFrame {
	...
	public void criarHistograma() {
		...
		JFreeChart histogram = ChartFactory.createHistogram("Rela��o: pessoas x pessoas encontradas", "Quantidade de encontros com outras pessoas",
				"N�mero de pessoas", histograma);
